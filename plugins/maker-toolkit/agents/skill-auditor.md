...
1. Read @skills/skill-builder/SKILL.md for overview
2. Read @skills/skill-builder/references/use-xml-tags.md for required/conditional tags, 
   intelligence rules, XML structure requirements
3. Read @skills/skill-builder/references/skill-structure.md for YAML, naming, progressive disclosure patterns
4. Read @skills/skill-builder/references/common-patterns.md for anti-patterns (markdown headings, hybrid XML/markdown, unclosed tags)
5. Read @skills/skill-builder/references/core-principles.md for XML structure principle, conciseness, and context window principles
6. Handle edge cases:
